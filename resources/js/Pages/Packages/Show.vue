                        ...
                        <div class="mb-6 flex items-center">
                            <h2 class="text-xl font-semibold text-gray-900 dark:text-gray-100 flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg"
                                    class="h-6 w-6 mr-2 text-indigo-600 dark:text-indigo-400" fill="none"
                        ...
                        <div
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="flex md:col-span-2">
                                    ...
                                    <div>
                                        <h4 class="text-sm font-medium text-gray-500 dark:text-gray-400">Description
                                        </h4>
                                ...
                                <div class="flex">
                                    ...
                                    <div>
                                        ...
                                        <p class="mt-1 text-base text-gray-900 dark:text-gray-100">
                                            {{ package.created_at ? moment(package.created_at).format('LLL') : 'Not set'
                                            }}
                                        </p>
                                    </div>
                                </div>
